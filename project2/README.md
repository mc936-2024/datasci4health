...
No modelo lógico do grafo, há duas relações possíveis entre proteínas: a ativação e a inibição da função de uma pela outra. Fármacos externos podem ser inibidores, antagonistas ou agonistas com relação às protiínas ou seus genes respectivos. A expressão dos genes e proteínas é definida pelo subtipo de alteração molecular, com as proteínas e genes mais expressos em um subtipo específico tendo uma relação de "pertencimento" a ele. Note que os subtipos tem como atributo o progóstico, que varia entre bom, intermediário e ruim.

## Integração entre bases

<!-- ## Análise preliminar (Não obrigatório) -->
